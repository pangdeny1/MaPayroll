                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="productModal{{ $incometype->id }}" tabindex="-1" role="dialog" aria-labelledby="productModalLabel{{ $incometype->id }}" aria-hidden="true">
                                                    <form action="{{ route("group_products.update", $incometype->id) }}" method="post">
                                                        @csrf
                                                        @method("patch")
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="productModalLabel{{ $incometype->id }}">
                                                                        Group product form ({{ $incometype->othincdesc }})
                                                                    </h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label>Product</label>
                                                                        <p><strong>{{ $incometype->othincdesc }}</strong></p>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-row">
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="hidden" othincdesc="currency" value="TZS">
                                                                                <input type="text"
                                                                                       othincdesc="amount"
                                                                                       id="amount"
                                                                    ...
                                                                    <div class="form-row">
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <select othincdesc="unit" id="unit" class="form-control">
