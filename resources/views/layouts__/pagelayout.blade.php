                ...
                <ul class="x-navigation">
                  ...
                  <li class="xn-openable active">
                    ...
                    <li class="xn-openable">
                        ...
                        <a href="#"><span class="fa fa-dashboard"></span> <span class="xn-text">Administration</span></a>
                         <ul>
                    ...
                    <li class="xn-openable">
                        ...
                        <a href="#"><span class="fa fa-dashboard"></span> <span class="xn-text">Employeees</span></a>
                         <ul>
                            ...
                            <li><a href="{{url('employeemaster')}}"><span class="fa fa-pencil-square-o"></span>Employee Master List</a></li>
                    ...
                    <li class="xn-openable">
                        ...
                        <a href="#"><span class="fa fa-dashboard"></span> <span class="xn-text">System Settings</span></a>
                         <ul>
